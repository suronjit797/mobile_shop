...
import { UserRoleFormat } from "@/interfaces/userInterface";
        ...
        <Card>
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Role: {UserRoleFormat[user?.role]}</p>
            </div>
          </div>
          <Descriptions bordered column={1}>
            <Descriptions.Item label="Name">{user?.name}</Descriptions.Item>
            <Descriptions.Item label="Email">{user?.email}</Descriptions.Item>
            <Descriptions.Item label="Role">{UserRoleFormat[user?.role]}</Descriptions.Item>
          </Descriptions>
